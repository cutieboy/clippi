                ...
                <div className="auth">
                    ...
                    <form className="auth-form" onSubmit={handleSubmit}>
                        ...
                        <div className="form-group" id="password-confirmation">
                            <input placeholder="Confirm Password" className="auth-input" ref={passwordConfirmRef} type="password" required />
                        </div>
                        <button className="auth-button" disable={loading} type="submit">Sign Up</button>
                    </form>
